...
/**
 * This output writer sends data to a host/port combination in the Metricsd
 * format via udp .
 * 
 * @see <a
 *      href="https://github.com/mojodna/metricsd">https://github.com/mojodna/metricsd</a>
 * 
 * @author Yongjun Rong
 */
public class MetricsdWriter extends GraphiteWriter {
	...
	private static final Logger log = LoggerFactory
			.getLogger(MetricsdWriter.class);
	...
	public void start() throws LifecycleException {
		try {
			...
			this.mbean = new ManagedGenericKeyedObjectPool(
					...
					Server.DATAGRAM_SOCKET_FACTORY_POOL);
	...
	public void doWrite(Query query) throws Exception {
		...
		DatagramSocket socket = (DatagramSocket) this.pool
				.borrowObject(address);
		try {
				...
				if (resultValues != null) {
					for (Entry<String, Object> values : resultValues.entrySet()) {
						if (JmxUtils.isNumeric(values.getValue())) {
							...
							String keyStr = JmxUtils.getStatsdKeyString(query,
									result, values, typeNames, rootPrefix);
